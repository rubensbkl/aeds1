...
/*
   ...
   para compilar: gcc -o 20xx-x_aed1_Exemplo_00.exe 20xx-x_aed1_Exemplo_00.c
   para executar: 20xx-x_aed1_Exemplo_00.
   no Linux (execucao em terminal (shell)):
   para compilar: gcc -o 20xx-x_aed1_Exemplo_00     20xx-x_aed1_Exemplo_00.c
   para executar: ./20xx-x_aed1_Exemplo_00.
*/

/**
   Comentarios para documentacao automatica (Dox_) 
   precedem as descricoes dados e acoes.
*/
